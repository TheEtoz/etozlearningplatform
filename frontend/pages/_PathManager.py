"""Legacy redirect — modules/lectures are managed inside Classes."""
...
st.set_page_config(page_title="Coding Path | ETOZ", page_icon="🗺️", layout="centered")
init_session_state()
require_teacher()
st.info("Coding modules and lectures are managed inside each class.")
